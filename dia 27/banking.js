class CuentaBancaria {
  ...
  listar() {
    return this.movimientos_transformados(this.movimientos);
  }
  buscar(valor) {
    let array_movimientos_filtrados = this.filtrarMovimientos(valor);
    return this.movimientos_transformados(array_movimientos_filtrados);
  }
